defmodule Writer do
  ...
  ## Elimina un empleado del archivo JSON por ID.
  ...
  ## Exporta a los empleados a un archivo YAML.
  ...
  ## Exporta a los empleados a un archivo CSV.
  #def export_employees_to_csv(filename \\ "employees.json") do
    #employees = read_employees(filename)
    #csv = NNimbleCSV.RFC4180.dump_to_iodata!(employees)
    #File.write("employees.csv", csv)
  #end
